...
Kontur.BrowserUpdateToolbar = (function (ws) {
    ...
    function generateToolbar() {
        var htmlObjects = '';
        htmlObjects += '<div class="browser-update-toolbar" style="background:#363636; font-family: Segoe UI, Helvetica Neue, Roboto, Arial, Liberation Sans, Nimbus Sans L, system-ui, -apple-system, sans-serif; line-height:70px; color:#ffffff; text-align:center;">';
